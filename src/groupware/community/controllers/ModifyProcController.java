...
public class ModifyProcController implements Controller {
	...
	public String execute(HttpServletRequest request,
		...
		try {
			mul = new MultipartRequest(request, uploadPath, 20 * 1024 * 1024,
		...
		String bc_no = mul.getParameter("bc_no");
		if (bc_no == null || bc_no.equals("")) {
		...
		DTO.setBc_no(Integer.parseInt(bc_no));
		...
		int af = CommunityDAO.getInstance().modify(DTO);
		/*
		...
		if (oriFileName1 != null || oriFileName2 != null) {
			...
			fDTO.setFile_number(Integer.parseInt(bc_no));
		...
		String backurl = "/Community/View.community?type=" + type + "&code="
				+ code +"&bc_no="+bc_no;
		return "js:url:수정이 완료되었습니다:" + backurl;
	}
