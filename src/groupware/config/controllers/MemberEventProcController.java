...
public class MemberEventProcController implements Controller {
	...
	public String execute(HttpServletRequest request,
		...
		if (mode.equals("CERTIFY_EDIT")) {
			...
			int af = MemberDao.getInstance().CertifyEdit(Integer.parseInt(temp[0]), Integer.parseInt(temp[1]));
			if (af > 0) {
